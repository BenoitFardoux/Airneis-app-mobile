...
class LegalNoticeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    decoration: BoxDecoration(
          color: const Color.fromARGB(255, 255, 255, 255), // Couleur de fond du SingleChildScrollView
    ),
     ...
     SingleChildScrollView(
      ...
      child: RichText(
          text: TextSpan(
            style: TextStyle(color: const Color.fromARGB(255, 2, 2, 2), fontSize: 16), text:
      ...
      child: RichText(
        text: TextSpan(
          style: TextStyle(
              ...
              fontSize: 16), // Texte en noir et taille de police 16
          children: <TextSpan>[
            TextSpan(
                text:
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 20),
              Image.network('https://arnaudrein.wordpress.com/wp-content/uploads/2024/06/boutique.webp?w=1024'),  // Replace with actual URL
              SizedBox(height: 20),
              Text(
                "Nous sommes fiers de contribuer à l'économie locale en employant des artisans locaux et en utilisant des matériaux écologiquement responsables. Chaque pièce est fabriquée à la main avec une attention méticuleuse aux détails, garantissant non seulement un design magnifique mais aussi une durabilité exceptionnelle.", textAlign: TextAlign.justify,
                style: TextStyle(fontSize: 16),
              ),
              SizedBox(height: 20),
              Text(
                "Notre voyage continue, et chaque nouveau design s'inspire des histoires, des paysages et des gens de l'Écosse. Nous vous remercions de faire partie de cette aventure.",textAlign: TextAlign.justify,
                style: TextStyle(fontSize: 16),
              ),
            ],
          ),
